...
// CONCATENATED MODULE: ./src/components/vue-draggable-resizable.vue?vue&type=template&id=7eb21aca&
...
/* harmony default export */ var vue_draggable_resizablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    calcResizeLimits: function calcResizeLimits() {
      ...
      var maxW = this.maxW;
      var maxH = this.maxH;
      var aspectFactor = this.w / this.h;
